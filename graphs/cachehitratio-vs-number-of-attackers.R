...
data.all$Scenario = ordered (data.all$Scenario,
  c("Lru", "Random", "Nocache"))

levels(data.all$Scenario) <- sub("^Nocache$", "Lru", levels(data.all$Scenario))
levels(data.all$Scenario) <- sub("^Random$", "Randomly Cache", levels(data.all$Scenario))
levels(data.all$Scenario) <- sub("^Lru$", "Nocache", levels(data.all$Scenario))
